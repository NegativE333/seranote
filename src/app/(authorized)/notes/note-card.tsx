                        ...
                        >
                            ...
                            <div className="mt-4 flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-2">
                                    <button className="p-2 rounded-full text-gray-400 hover:text-white hover:bg-white/10"><LinkIcon className="w-4 h-4" /></button>
                                    <button className="p-2 rounded-full text-gray-400 hover:text-white hover:bg-white/10"><TrashIcon className="w-4 h-4" /></button>
                                </div>
                            </div>
                        </motion.div>
                    )}
