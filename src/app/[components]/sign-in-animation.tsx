...
export const SignInContent = () => {
  ...
  return (
    <motion.div
      ...
      animate="visible"
    >
      <motion.div className="relative w-full max-w-xl p-8" variants={itemVariants}>
        <motion.div className="absolute top-0 left-0 text-white/10" variants={iconVariants}>
        ...
        >
          {words.map((word, index) => (
            <motion.span key={index} className="inline-block mr-[0.5rem]" variants={wordVariants}>
              {word}
            </motion.span>
          ))}
        </motion.h1>
